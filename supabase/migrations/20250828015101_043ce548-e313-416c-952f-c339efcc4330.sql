...
CREATE INDEX idx_campaign_refresh_logs_started_at ON campaign_refresh_logs(started_at DESC);
CREATE INDEX idx_daily_campaign_performance_date ON daily_campaign_performance(date_recorded DESC);
CREATE INDEX idx_campaign_url_analytics_date ON campaign_url_analytics(date_recorded DESC);
