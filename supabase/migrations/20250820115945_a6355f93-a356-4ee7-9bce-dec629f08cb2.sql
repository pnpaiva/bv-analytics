...
CREATE TABLE IF NOT EXISTS public.public_media_kits (
...
CREATE POLICY IF NOT EXISTS "Anyone can view published media kits"
ON public.public_media_kits
FOR SELECT
USING (published = true);

-- Owners can manage their own media kits
CREATE POLICY IF NOT EXISTS "Owners can manage their media kits"
ON public.public_media_kits
FOR ALL
...
-- Attach trigger
DROP TRIGGER IF EXISTS update_public_media_kits_updated_at ON public.public_media_kits;
