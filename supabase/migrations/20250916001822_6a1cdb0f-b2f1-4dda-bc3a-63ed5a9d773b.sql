...
-- 1. Create RLS policies for organizations table
...
-- 2. Create RLS policies for organization_members table
...
-- 3. Update existing RLS policies to be organization-aware
